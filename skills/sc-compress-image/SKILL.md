...
./sc-run sc-compress-image main path/to/image.png

# Compress with specific format and quality
./sc-run sc-compress-image main path/to/image.png --format png --quality 75

# Process directory recursively
./sc-run sc-compress-image main ./images/ --recursive --keep
```
