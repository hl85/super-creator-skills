...
All commands use `./sc-run sc-format-markdown <script>`.
...
./sc-run sc-format-markdown main article.md --quotes

# Full formatting workflow
./sc-run sc-format-markdown main article.md --optimize
```
