...
function printUsage(): never {
  console.log(`Post to Xiaohongshu (小红书) using real Chrome browser

Usage:
  ./sc-run post-to-xhs note [options]
...
Examples:
  ./sc-run post-to-xhs note --title "标题" --caption "正文" --image ./img1.png --image ./img2.png
  ./sc-run post-to-xhs note --title "标题" --caption-file caption.md --image ./img.png --publish
`);
  process.exit(0);
}
