...
> 本文档基于 post-to-xhs skill 的 `references/mcp-integration.md` 精简，只保留 xhs-pipeline 需要了解的 MCP 配置和使用方法。完整信息请参考 post-to-xhs skill 的官方文档。
...
> 注：完整工具列表（共 13 个）及详细说明，请参考 post-to-xhs skill 的 mcp-integration.md 文档。
