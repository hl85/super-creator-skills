...
All commands use `./sc-run sc-gemini-web main`.

```bash
# Text generation
./sc-run sc-gemini-web main "Explain quantum computing"

# Image generation
./sc-run sc-gemini-web main --prompt "A futuristic lab" --image sci-fi.png

# Vision input
./sc-run sc-gemini-web main --prompt "Describe this" --ref image.png

# Multi-turn session
./sc-run sc-gemini-web main "Remember 42" --sessionId my-chat
```
