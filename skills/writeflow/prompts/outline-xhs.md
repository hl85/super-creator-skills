...
Read the source material (1v1 纪要, content-mining output, etc.) end to end. If a source is > 3000 字, extract 5 key bullets first.

## Step 2 — Confirm core claim

The whole note argues **exactly one** claim. If content-mining output exists, use its recommended claim. Otherwise:
