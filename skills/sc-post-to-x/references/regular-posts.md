...
```bash
# Post text
./sc-run sc-post-to-x x-api "Hello from API!"

# Post with images
./sc-run sc-post-to-x x-api "Check this out!" --image ./photo.png

# Post with multiple images (up to 4)
./sc-run sc-post-to-x x-api "Gallery!" --image ./1.png --image ./2.png --image ./3.png --image ./4.png

# Use specific account
./sc-run sc-post-to-x x-api "Hello!" --account work
...
./sc-run sc-post-to-x x-browser "Hello!" --image ./photo.png

# Quote an existing tweet
./sc-run sc-post-to-x x-quote https://x.com/user/status/123 "Great insight!"
```
...
```bash
./sc-run sc-post-to-x copy-to-clipboard image /path/to/image.png
```
...
./sc-run sc-post-to-x paste-from-clipboard

# Paste to Chrome with retries
./sc-run sc-post-to-x paste-from-clipboard --app "Google Chrome" --retries 5

# Quick paste with shorter delay
./sc-run sc-post-to-x paste-from-clipboard --delay 200
```
...
- **Credentials not found**: Run `./sc-run sc-post-to-x x-api --check` to verify
