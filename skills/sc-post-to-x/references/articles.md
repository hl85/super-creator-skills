...
./sc-run sc-post-to-x x-article article.md

# With custom cover image
./sc-run sc-post-to-x x-article article.md --cover ./cover.jpg

# Actually publish
./sc-run sc-post-to-x x-article article.md --submit
```
...
./sc-run sc-post-to-x md-to-html article.md

# Output HTML only
./sc-run sc-post-to-x md-to-html article.md --html-only

# Save HTML to file
./sc-run sc-post-to-x md-to-html article.md --save-html /tmp/article.html
```
...
- **Content not pasting**: Check HTML clipboard: `./sc-run sc-post-to-x copy-to-clipboard html --file /tmp/test.html`
