...
| Intent | Command |
|--------|---------|
| **Regular Post (API)** | `./sc-run sc-post-to-x x-api "Hello!" --image ./photo.png` |
| **Regular Post (Browser)** | `./sc-run sc-post-to-x x-browser "Hello!" --image ./photo.png` |
| **Video Post** | `./sc-run sc-post-to-x x-video "Check this out!" --video ./clip.mp4` |
| **Quote Tweet** | `./sc-run sc-post-to-x x-quote https://x.com/status/123 "Comment"` |
| **X Article** | `./sc-run sc-post-to-x x-article article.md` |
| **Check Env** | `./sc-run sc-post-to-x x-api --check` |
| **Thread from JSON** | `./sc-run sc-post-to-x x-api --thread thread.json` |
...
- Input: thread.json 格式参考 sc-markdown-to-thread skill 的输出
