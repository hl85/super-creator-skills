...
All commands use `./sc-run sc-post-to-wechat <script>`.

```bash
# Article via API (Recommended)
./sc-run sc-post-to-wechat wechat-api <file> --theme default

# Article via Browser
./sc-run sc-post-to-wechat wechat-article --markdown <file>

# Image-Text post
./sc-run sc-post-to-wechat wechat-browser --markdown <file> --images ./images/

# Check environment
./sc-run sc-post-to-wechat check-permissions
```
