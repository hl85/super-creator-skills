...
description: First-time setup flow for sc-post-to-wechat preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.super-creator/post-to-wechat/EXTEND.md` | Current project |
| User | `~/.super-creator/post-to-wechat/EXTEND.md` | All projects |
