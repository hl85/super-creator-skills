...
```bash
./sc-run sc-post-to-wechat wechat-api <file> --theme <theme> [--color <color>] [--title <title>] [--summary <summary>] [--author <author>] [--cover <cover_path>] [--no-cite]
```
...
```bash
./sc-run sc-post-to-wechat wechat-article --markdown <markdown_file> --theme <theme> [--color <color>] [--no-cite]
./sc-run sc-post-to-wechat wechat-article --html <html_file>
```
