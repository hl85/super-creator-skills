...
export function loadWechatExtendConfig(): WechatExtendConfig {
  const paths = [
    path.join(process.cwd(), ".super-creator", "post-to-wechat", "EXTEND.md"),
    path.join(
      process.env.XDG_CONFIG_HOME || path.join(os.homedir(), ".config"),
      "super-creator", "post-to-wechat", "EXTEND.md"
    ),
    path.join(os.homedir(), ".super-creator", "post-to-wechat", "EXTEND.md"),
  ];
