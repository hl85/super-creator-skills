...
All commands use `./sc-run sc-markdown-to-html main`.

```bash
# Standard conversion (default theme)
./sc-run sc-markdown-to-html main article.md

# Specific theme and color
./sc-run sc-markdown-to-html main article.md --theme grace --color rose

# Enable bottom citations (WeChat friendly)
./sc-run sc-markdown-to-html main article.md --cite
```
